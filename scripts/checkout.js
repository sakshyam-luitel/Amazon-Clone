...
document.querySelectorAll('.js-delete-link').forEach((link)=>
  ...
  document.querySelectorAll('.js-update-quantity-link').forEach((updateLink) => {
    updateLink.addEventListener('click' , () => {
      ...
      const checkBoxHTML = '<input class = "quantity-input" type = "text"> <span class = "save-quantity-link js-save-quantity-link">Save</span>';

      document.querySelector(`.js-update-quantity-link-${productId}`).innerHTML = checkBoxHTML;
